...
class SpeedPointAgent:
    ...
    def process_network_responses(self):
        ...
        try:
            ...
            self.root.after(100, self.process_network_responses) # Kuyruğu periyodik olarak kontrol et
    ...
    def setup_ui(self, lock_mode=True):
        # Eğer durum zaten aynıysa, gereksiz yere arayüzü yeniden çizmeyi önle
    ...
    def poll_firebase(self):
        ...
        # Sadece bir "GET" isteği kuyrukta bekleyebilir.
    ...
    def sync_to_firebase(self, is_locked, remaining_time):
        ...
        payload = {
            "fields": {
                ...
                "remainingTime": {"integerValue": str(int(remaining_time))}
            }
        }
